    ...
    <section className="w-full bg-[#F7F8FC] py-16">
      <div className="mx-auto flex max-w-[1170px]">
        <div className="relative mx-auto flex max-w-[521px] flex-col items-start">
          <h2 className="text-tw-h2 font-tw-display text-left font-bold">
            What People Say{' '}
            <span className="text-tw-primary-orange">About Us</span>
          </h2>
          <p className="text-tw-light-gray text-tw-p2 mx-auto mt-4 text-left">
          ...
          <div className="items-left mt-4 flex h-max justify-start gap-3">
            <button
              ...
              className="bg-tw-background-white flex h-5 w-5 items-center justify-center rounded-full border border-[#999999]/50 transition hover:bg-gray-100"
            ...
            <button
              ...
              className="bg-tw-primary-orange flex h-5 w-5 items-center justify-center rounded-full transition hover:bg-orange-600"
