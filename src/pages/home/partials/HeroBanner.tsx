      ...
      >
        <div className={classNames("flex items-center justify-center w-[1600px]", styles.heroContainer)}>
          <div className="w-[760px] mt-[50px]">
            ...
            <div className={classNames("flex w-[500px] justify-flex-start", styles.buttonContainer)}>
              <button 
                onClick={onScroll}
          ...
          <div className={classNames("flex items-center justify-center w-[760px]", styles.heroImageContainer)}>
